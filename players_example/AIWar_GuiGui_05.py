...
def play_base_test(self):
    ...
    # TEST sur les UInt
    #self.setMemoryUInt(0, 0)
    #self.log( "setMemoryUInt(0, 0)= " + str(self.getMemoryUInt(0)) )
    #self.setMemoryUInt(0, 0-1)
    #self.log( "setMemoryUInt(0, 0-1)= "+ str(self.getMemoryUInt(0)) )
    #self.setMemoryUInt(0, 0+1)
    #self.log( "setMemoryUInt(0, 0+1)= "+ str(self.getMemoryUInt(0)) )
    #self.setMemoryUInt(0, 4294967295+1)
    #self.log( "setMemoryUInt(0, 4294967295+1)= "+ str(self.getMemoryUInt(0)) )
    
    #self.setMemoryUInt(0, int(0))
    #self.log( "setMemoryUInt(0, int(0))= " + str(self.getMemoryUInt(0)) )
    #self.setMemoryUInt(0, int(0-1))
    #self.log( "setMemoryUInt(0, int(0-1))= "+ str(self.getMemoryUInt(0)) )
    #self.setMemoryUInt(0, int(0+1))
    #self.log( "setMemoryUInt(0, int(0+1))= "+ str(self.getMemoryUInt(0)) )
    #self.setMemoryUInt(0, int(4294967295+1))
    #self.log( "setMemoryUInt(0, int(4294967295+1))= "+ str(self.getMemoryUInt(0)) )
